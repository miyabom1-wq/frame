const CACHE='frame-v0.15.0-candidate-board';
const ASSETS=['./vantage-watch-sync-v015.js','./','./index.html','./manifest.json','./icon-v010-192.png','./icon-v010-512.png','./icon-v010-maskable-192.png','./icon-v010-maskable-512.png','./apple-touch-icon-v010.png'];
