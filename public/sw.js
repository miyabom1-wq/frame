const CACHE='frame-v0.11.0-install-fix';
const ASSETS=['./','./index.html','./manifest.json?v=0.11-pwa','./icon-v010-192.png','./icon-v010-512.png','./icon-v010-maskable-192.png','./icon-v010-maskable-512.png','./apple-touch-icon-v010.png'];
