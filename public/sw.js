const CACHE='frame-v0.14.0-vantage-auto-analysis';
const ASSETS=['./vantage-watch-sync-v014.js','./','./index.html','./manifest.json','./icon-v010-192.png','./icon-v010-512.png','./icon-v010-maskable-192.png','./icon-v010-maskable-512.png','./apple-touch-icon-v010.png'];
